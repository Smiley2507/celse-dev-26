...
const socials = [
  ...
  { icon: RiMailLine,         href: 'mailto:hello@celse.com', name: 'Email' },
  { icon: RiDribbbleLine,     href: '#',                       name: 'Dribbble' },
]
